...
public class ExactLengthValidatorTests : TransformerTestBase
{
    ...
    [Fact]
    public async Task TransformAsync_ExactLength()
    {
        // ARRANGE
        const int exactLength = 10;
        var validator = new ExactLengthValidator(exactLength);
        var expectedSchema = new OpenApiSchema
        {
            Type = JsonSchemaType.String,
        ...
        var transformer = new RequestValidationTransformer<ExactLengthValidator, TestRequest>();
