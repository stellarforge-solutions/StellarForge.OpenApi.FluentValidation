...
public class JsonPointerValidatorTests : TransformerTestBase
{
    [Fact]
    public async Task TransformAsync_Format()
    {
        // ARRANGE
        var validator = new JsonPointerValidator();
        var expectedSchema = new OpenApiSchema
        {
            Type = JsonSchemaType.String,
            Format = StringFormats.JsonPointer,
        };
        ...
        var transformer = new RequestValidationTransformer<JsonPointerValidator, TestRequest>();
